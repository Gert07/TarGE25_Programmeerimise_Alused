...
class Zoo:
    ...
    def __init__(self, name: str, max_number_of_animals: int):
        ...
        """
        self.name = name
        self.amount = max_number_of_animals
        self.animals: list[Animal] = []  # list to keep track of all the animals
    ...
    def can_add_animal(self, animal: Animal) -> bool:
        ...
        """
        if len(self.animals) >= self.amount:
            return False

        if animal in self.animals:
            return False

        for existing in self.animals:
            if existing.name == animal.name and existing.species == animal.species:
                return False
    ...
    def get_all_animals(self):
        ...
        """
        return self.animals[:]  # returns a copy just in case
